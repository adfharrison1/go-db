...
const COLLECTION = 'test_max_throughput_v1';

export function setup() {
  console.log('Setting up V1 max throughput test...');
  console.log(
  ...
  console.log('V1 max throughput test setup complete');
  return {};
}
...
export function teardown(data) {
  console.log('V1 max throughput test teardown complete');
}
